...
INSERT INTO data_hub.task (id, task_key, task_name, jar_path, transform_sql, hive_support, spark_config, latch, created, modified, yn) VALUES (2, 'file2jdbc_local', '本地模式从jdbc导数据到hive中', 'D:\\workspace\\data-hub\\target\\data-hub.jar', 'select * from my_temp_view', 0, '{"spark.master":"local[2]", "spark.executor.cores":2, "spark.driver.memory":"1g"}', 1, '2021-07-02 08:50:31', '2021-07-02 08:50:37', 1);
...
INSERT INTO data_hub.sink (id, task_id, sink_type, sink_config_type, sink_config_json, created, modified, yn) VALUES (2, 2, 'com.issac.studio.app.sink.JdbcSink', 'com.issac.studio.app.entity.domain.config.sink.JdbcSinkConfig', '{"url": "jdbc:mysql://localhost:3306/data_hub?characterEncoding=utf8&amp;useUnicode=true&amp;useSSL=false&amp;serverTimezone=UTC&amp;allowPublicKeyRetrieval=true", "driverClass": "com.mysql.cj.jdbc.Driver", "tableName": "test_student", "user": "root", "passwd": "123456", "partitionNum": "2", "saveMode": "append"}', '2021-07-03 13:09:43', '2021-07-03 13:09:44', 1);