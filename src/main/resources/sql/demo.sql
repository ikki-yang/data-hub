INSERT INTO data_hub.task (id, task_key, task_name, jar_path, transform_sql, hive_support, spark_config, latch, created, modified, yn) VALUES (1, 'hdfs2hbase_cluster', '集群模式从jdbc导数据到hive中', '/target/data-hub.jar', 'select
